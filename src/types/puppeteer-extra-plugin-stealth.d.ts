declare module 'puppeteer-extra-plugin-stealth' {
    ...
    declare function defaultExport(opts?: { enabledEvasions?: Set<string> }): StealthPlugin;
    declare const StealthPlugin_base: typeof import('puppeteer-extra-plugin').PuppeteerExtraPlugin;

    export type StealthPluginOptions = Record<string, unknown>;
    /**
    ...
    declare class StealthPlugin extends StealthPlugin_base {
        ...
        constructor(opts?: StealthPluginOptions);
        get defaults(): {
